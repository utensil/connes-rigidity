...
| §2 groups | `Connes.Construction.PaperKernel.paperGammaOne`, `paperGammaTwo` |
...
| §4 action-indexed extension spine | `Connes.PaperPropertyT.lambdaOf`, `Connes.PaperSplitExtensions.lambdaExtension`, `Connes.PaperFiniteExtensions.finiteExtension`, `Connes.PaperSpectralPropertyT.SpectralData` |
...
| §5 ICC orbits and completion | `Connes.PaperICC.paper_actionData_one`, `paper_actionData_two`, `paper_gammaOne_icc`, `paper_gammaTwo_icc` |
