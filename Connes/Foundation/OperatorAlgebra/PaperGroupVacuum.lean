...
theorem paperGroupFactorUnitaryOne_vacuum :
  ...
  · subst h
    have hfiber :
      ...
      simp only [paperIdentityOne, semidirectFubini_apply, lp.single_apply,
        Pi.single_apply,
        SemidirectProduct.ext_iff, SemidirectProduct.left_inl,
        SemidirectProduct.one_left, ofAdd_eq_one, ofAdd_zero,
        SemidirectProduct.right_inl, SemidirectProduct.one_right, and_true]
  ...
  · have hfiber :
      ...
      simp only [paperIdentityOne, semidirectFubini_apply, lp.single_apply,
        ...
        and_false, not_false_eq_true, if_false, Pi.single_eq_of_ne,
