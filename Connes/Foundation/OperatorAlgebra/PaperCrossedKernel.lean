...
-/
import Connes.Foundation.OperatorAlgebra.PaperFourierCoordinates
import Connes.Foundation.OperatorAlgebra.PaperCrossedHaar
...
theorem coordinateCharacterMultiplier_eq_baseMultiplier (d : D) :
  ...
  change (coordinateCharacterMultiplier d ξ : Coordinates → ℂ) p = _
