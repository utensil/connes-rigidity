...
import Connes.Foundation.OperatorAlgebra.PaperChartMeasure
...
def characterActionOfLinear (e : D ≃ₗ[k] D) :
  ...
  toFun := PaperChartMeasure.dualCharacterEquiv e.toAddEquiv
  invFun := (PaperChartMeasure.dualCharacterEquiv e.toAddEquiv).symm
  left_inv χ := (PaperChartMeasure.dualCharacterEquiv e.toAddEquiv).left_inv χ
  right_inv χ := (PaperChartMeasure.dualCharacterEquiv e.toAddEquiv).right_inv χ
  map_add' χ ψ := (PaperChartMeasure.dualCharacterEquiv e.toAddEquiv).map_add χ ψ
...
theorem continuous_characterActionOfLinear (e : D ≃ₗ[k] D) :
  ...
  exact PaperChartMeasure.dualCharacterEquiv_continuous e.toAddEquiv
